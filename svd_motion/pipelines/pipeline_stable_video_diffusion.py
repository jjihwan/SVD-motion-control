...
from ..models.unets.unet_spatio_temporal_condition import UNetSpatioTemporalConditionModel
...
class StableVideoDiffusionPipeline(DiffusionPipeline):
    ...
    def __call__(
        ...
        added_time_ids = self._get_add_time_ids( # [fps, motion_bucket_id, noise_aug_strength] = [6, 127, 0.02]
            fps,
            motion_bucket_id,
            noise_aug_strength,
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                noise_pred = self.unet(
                    latent_model_input, # [2, 25, 8, 64, 64]
                    t,
                    encoder_hidden_states=image_embeddings, # [2, 1, 1024]
                    added_time_ids=added_time_ids, # [2, 3]
                    return_dict=False,
                )[0]
